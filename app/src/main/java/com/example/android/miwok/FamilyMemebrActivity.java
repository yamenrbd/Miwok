...
public class FamilyMemebrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ;
                releaseMediaPlayer();
                mediaPlayer = MediaPlayer.create(FamilyMemebrActivity.this,words.get(position).getmSongId());
                mediaPlayer.start();
    ...
    private void releaseMediaPlayer() {
        ...
        if (mediaPlayer != null) {
            ...
            mediaPlayer = null;
            Toast.makeText(FamilyMemebrActivity.this,"the resource is relased",Toast.LENGTH_LONG).show();
        }
    }
}
